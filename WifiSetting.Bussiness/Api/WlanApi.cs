	...
	public class WlanClient : IDisposable
	{
		...
		public class WlanInterface
		{
			...
			private void SetInterfaceInt(Wlan.WlanIntfOpcode opCode, int value)
			{
				...
				{
					Wlan.ThrowIfError(
						Wlan.WlanSetInterface(_client.clientHandle, _info.interfaceGuid, opCode, sizeof(int), valuePtr, IntPtr.Zero));
				}
				finally
				{
			...
			private int GetInterfaceInt(Wlan.WlanIntfOpcode opCode)
			{
				...
				Wlan.ThrowIfError(
					Wlan.WlanQueryInterface(_client.clientHandle, _info.interfaceGuid, opCode, IntPtr.Zero, out valueSize, out valuePtr, out opcodeValueType));
				try
				{
			...
			public Wlan.WlanRadioState RadioState
			{
				get
				{
					...
					Wlan.WlanOpcodeValueType opcodeValueType;
					Wlan.ThrowIfError(
						Wlan.WlanQueryInterface(_client.clientHandle, _info.interfaceGuid, Wlan.WlanIntfOpcode.RadioState, IntPtr.Zero, out valueSize, out valuePtr, out opcodeValueType));
					try
					{
			...
			public Wlan.WlanConnectionAttributes CurrentConnection
			{
				get
				{
					...
					Wlan.WlanOpcodeValueType opcodeValueType;
					Wlan.ThrowIfError(
						Wlan.WlanQueryInterface(_client.clientHandle, _info.interfaceGuid, Wlan.WlanIntfOpcode.CurrentConnection, IntPtr.Zero, out valueSize, out valuePtr, out opcodeValueType));
					try
					{
			...
			{
				Wlan.ThrowIfError(
					Wlan.WlanScan(_client.clientHandle, _info.interfaceGuid, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero));
			}
			...
			public Wlan.WlanAvailableNetwork[] GetAvailableNetworkList(Wlan.WlanGetAvailableNetworkFlags flags)
			{
				...
				Wlan.ThrowIfError(
					Wlan.WlanGetAvailableNetworkList(_client.clientHandle, _info.interfaceGuid, flags, IntPtr.Zero, out availNetListPtr));
				try
				{
			...
			public Wlan.WlanBssEntry[] GetNetworkBssList()
			{
				IntPtr bssListPtr;
				Wlan.ThrowIfError(
					Wlan.WlanGetNetworkBssList(_client.clientHandle, _info.interfaceGuid, IntPtr.Zero, Wlan.Dot11BssType.Any, false, IntPtr.Zero, out bssListPtr));
				try
				{
			...
			public Wlan.WlanBssEntry[] GetNetworkBssList(Wlan.Dot11Ssid ssid, Wlan.Dot11BssType bssType, bool securityEnabled)
			{
				...
				try
				{
					IntPtr bssListPtr;
					Wlan.ThrowIfError(
						Wlan.WlanGetNetworkBssList(_client.clientHandle, _info.interfaceGuid, ssidPtr, bssType, securityEnabled, IntPtr.Zero, out bssListPtr));
					try
					{
						return ConvertBssListPtr(bssListPtr);
					}
			...
			{
				Wlan.ThrowIfError(
					Wlan.WlanConnect(_client.clientHandle, _info.interfaceGuid, ref connectionParams, IntPtr.Zero));
			}
			...
			{
				Wlan.ThrowIfError(
					Wlan.WlanDeleteProfile(_client.clientHandle, _info.interfaceGuid, profileName, IntPtr.Zero));
			}
			...
			public Wlan.WlanReasonCode SetProfile(Wlan.WlanProfileFlags flags, string profileXml, bool overwrite)
			{
				...
				Wlan.ThrowIfError(
						Wlan.WlanSetProfile(_client.clientHandle, _info.interfaceGuid, flags, profileXml, null, overwrite, IntPtr.Zero, out reasonCode));
				return reasonCode;
			}
			...
			public string GetProfileXml(string profileName)
			{
				...
				Wlan.ThrowIfError(
					Wlan.WlanGetProfile(_client.clientHandle, _info.interfaceGuid, profileName, IntPtr.Zero, out profileXmlPtr, out flags,
								   out access));
				try
				{
			...
			public Wlan.WlanProfileInfo[] GetProfiles()
			{
				...
				Wlan.ThrowIfError(
					Wlan.WlanGetProfileList(_client.clientHandle, _info.interfaceGuid, IntPtr.Zero, out profileListPtr));
				try
				{
